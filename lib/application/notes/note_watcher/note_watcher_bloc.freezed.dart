...
class __$$_LoadingInProgressCopyWithImpl<$Res>
  ...
  __$$_LoadingInProgressCopyWithImpl(
      ...
      : super(_value, (v) => _then(v as _$_LoadingInProgress));

  @override
  _$_LoadingInProgress get _value => super._value as _$_LoadingInProgress;
}
...
class _$_LoadingInProgress implements _LoadingInProgress {
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType && other is _$_LoadingInProgress);
  }
